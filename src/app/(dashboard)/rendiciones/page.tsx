import { IconRendiciones } from '@/components/ui/icons'

export default function RendicionesPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold text-gray-900">Rendiciones</h1>
        <p className="mt-1 text-sm text-gray-500">
          Rendiciones de cuentas y cierres de período.
        </p>
      </div>
      ...
      <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-gray-300 bg-white p-12 text-center">
        <div className="mb-3 text-gray-300">
          <IconRendiciones className="w-10 h-10" />
        </div>
